  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" style="min-height: 506px;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">Welcome to Voyager app</h1>
          </div>
          <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
        ...
        <div class="col-lg-7">
          <div class="panel panel-default">
            <div class="panel-body" style="height: 100%; width: 100%; padding: 0px;">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStbC2Klh2BQdISs0N9CCQbspPzJUZTnU3UxAuXzlIezBflubrEZA" alt="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStbC2Klh2BQdISs0N9CCQbspPzJUZTnU3UxAuXzlIezBflubrEZA" style="height: 100%; width: 100%;" >
            </div>
          </div>
        </div>
